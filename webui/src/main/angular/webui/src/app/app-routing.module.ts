...
const routes: Routes = [
	...
	{ path: 'member/startproject', 	component: StartProjectComponent, 	data: {name: 'StartProjectComponent', 	role: ['ALL']} },
	{ path: 'member/myprojects', 	component: MyProjectsComponent, 	data: {name: 'MyProjectsComponent', 	role: ['ALL']} },
];
